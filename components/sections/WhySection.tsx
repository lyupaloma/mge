...
const ICONS: Record<string, React.ReactNode> = {
  shield: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.955 11.955 0 003 10.5a9 9 0 006 8.52 9 9 0 006-8.52 11.955 11.955 0 00-.598-3.5 11.959 11.959 0 01-3.96-.964z" /></svg>,
...
export function WhySection() {
  ...
  return (
    <section className="py-20 lg:py-32 bg-bg-deep relative overflow-hidden">
      <div className="absolute inset-0 bg-radial-gold pointer-events-none opacity-60" />
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {items.map((item, i) => (
            <motion.div
              ...
              className="flex gap-4 p-6 rounded-2xl bg-bg-card/50 border border-bg-border hover:border-gold/20 transition-colors duration-300"
            >
